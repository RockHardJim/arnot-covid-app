            ...
            <div class="row appointment_box">
              ...
              <option name="supplier">
                Service Provider
                                    ...
                                    <label><i class="linearicons-user"></i>User Type</label>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <label><i class="linearicons-user"></i>SURNAME</label>
                                                        ...
                                                        <div class="col-lg-12">
                                <div class="form-group">
                                    <input class="form-control" type="text" id="vehicle_registration" name="vehicle_registration" placeholder="" />
                                    <label><i class="linearicons-car"></i>Vehicle Registration</label>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group">
